...
describe("Masker", () => {
  describe("maskName", () => {
    ...
    test("should properly mask an English name with 6 or more characters", () => {
  ...
  describe("maskPhoneNumber", () => {
    test("should properly mask a phone number separated by hyphens", () => {
    ...
    test("should mask a phone number not separated by hyphens", () => {
